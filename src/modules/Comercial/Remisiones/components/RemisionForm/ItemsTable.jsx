...
// ─── Tabla de ítems a despachar (editable) ─────────────────────────────────────
const ItemsTable = ({
  ...
  const columns = useMemo(() => [
    ...
    {
      key: 'cantidad', label: 'Cant.', align: 'right', className: 'w-20', sortable: false,
      render: (v, row) => {
        const idx = row.__idx;
    ...
    {
      key: 'precio_unit', label: 'Precio', align: 'right', className: 'w-28', sortable: false,
      render: (v, row) => {
        const idx = row.__idx;
    ...
    },
    {
      ...
      render: (v) => <span className="font-semibold text-content-secondary whitespace-nowrap">{fmt(v)}</span>,
    },
    {
