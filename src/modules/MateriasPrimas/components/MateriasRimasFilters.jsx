    ...
    <div className="flex items-center gap-2 bg-white border border-zinc-200 rounded-lg px-3 py-2">
      ...
      <div className="relative flex-1 min-w-0">
        ...
        <input
          ...
          className="w-full pl-8 pr-8 py-1.5 text-sm border border-zinc-200 rounded focus:outline-none focus:ring-1 focus:ring-violet-500 focus:border-violet-500"
        />
        {searchTerm && (
          <button
      ...
      <select
        ...
        className="text-sm border border-zinc-200 rounded px-2 py-1.5 text-zinc-700 focus:outline-none focus:ring-1 focus:ring-violet-500 bg-white cursor-pointer"
      >
      ...
      <label className="flex items-center gap-1.5 cursor-pointer whitespace-nowrap select-none">
        <input
          ...
          className="w-3.5 h-3.5 text-violet-600 rounded border-zinc-300 focus:ring-violet-500 cursor-pointer"
        />
