  ...
  if (isLoading) {
    return (
      <div className="py-16 text-center">
        ...
        <p className="text-sm text-zinc-500">Cargando materias primas...</p>
      </div>
    );
  }
  ...
  if (materiasRimas.length === 0) {
    return (
      <div className="py-16 text-center">
        ...
        <p className="text-sm text-zinc-500">No se encontraron materias primas</p>
              ...
              return (
                <React.Fragment key={item.id_item_general}>
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <span className="inline-block text-xs px-2 py-0.5 bg-violet-50 text-violet-700 rounded-full border border-violet-100">
                  ...
                  {isExpanded && (
                    <tr className="bg-zinc-50/60">
                      <td colSpan="7" className="px-3 py-0">
                        <div className="ml-5 border-l-2 border-violet-200 pl-4 py-3">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-t border-zinc-100 bg-white">
        <div className="flex items-center gap-2 text-xs text-zinc-500">
          ...
          <select
            ...
            className="border border-zinc-200 rounded px-1.5 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-violet-500 bg-white"
          >
            {[10, 25, 50, 100].map(n => (
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="px-2 py-1 text-xs border border-zinc-200 rounded hover:bg-zinc-50 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            «
          </button>
          <button
          ...
          <span className="px-3 py-1 text-xs text-zinc-600">
