...
export const PaginacionFooter = ({
  totalItems, paginatedLength, isComparison, perPage, setPerPage,
    ...
    <div className="px-3 py-2 bg-surface-subtle border-t border-border-base flex items-center justify-between">
      <div className="hidden sm:flex items-center gap-4">
        <div className="text-xs text-content-tertiary">
          Mostrando{' '}
          <span className="text-content-primary font-semibold tabular-nums">{paginatedLength}</span>{' '}
          de{' '}
